...
const ManagerDashboard = () => {
    ...
    const {tasks, loading: tasksLoading} = useManagerTasks()
    const {onAdd: addTask, onEdit: editTask, onDelete: deleteTask} = useTasks();
                                                        ...
                                                        <TableRow key={task.id}>
                                                            ...
                                                            <TableCell>
                                                                {assignedUser ? (
                                                                    ...
                                                                    <Typography
                                                                        className="table-unassigned-apple">Unassigned</Typography>
                                                                )}
                                                            </TableCell>
                                                            <TableCell>
                                                            ...
                                                            <TableCell align="right">
                                                                ...
                                                                <IconButton
                                                                    ...
                                                                    className="table-action-button-apple"
                                                                >
                                                ...
                                                <Card className="analytics-card-apple">
                                                    <CardContent sx={{p: 2.5}}>
                                                        <Box display="flex" alignItems="center" gap={2}>
                                                            ...
                                                            <Box flex={1}>
                                                                <Typography
                                                                    className="analytics-card-title-apple">Total</Typography>
                                                                <Typography className="analytics-card-value-apple"
                                                ...
                                                <Card className="analytics-card-apple">
                                                    <CardContent sx={{p: 2.5}}>
                                                        <Box display="flex" alignItems="center" gap={2}>
                                                            ...
                                                            <Box flex={1}>
                                                                <Typography
                                                                    className="analytics-card-title-apple">Completed</Typography>
                                                                <Typography className="analytics-card-value-apple" sx={{
                                                ...
                                                <Card className="analytics-card-apple">
                                                    <CardContent sx={{p: 2.5}}>
                                                        <Box display="flex" alignItems="center" gap={2}>
                                                            ...
                                                            <Box flex={1}>
                                                                <Typography
                                                                    className="analytics-card-title-apple">Pending</Typography>
                                                                <Typography className="analytics-card-value-apple" sx={{
                                                                    fontSize: '2rem !important',
                                                ...
                                                <Card className="analytics-card-apple">
                                                    <CardContent sx={{p: 2.5}}>
                                                        <Box display="flex" alignItems="center" gap={2}>
                                                            ...
                                                            <Box flex={1}>
                                                                <Typography className="analytics-card-title-apple">On
                                                                    Hold</Typography>
                                                                <Typography className="analytics-card-value-apple" sx={{
                                                                    fontSize: '2rem !important',
                                                        ...
                                                        <PieChart>
                                                            <Pie
                                                                data={[
                                                                    {
                                                                        name: 'Completed',
                                                                        value: analyticsTaskStats?.completed || 0
                                                                    },
                                                                    {
                                                                        name: 'Pending',
                                                                        value: analyticsTaskStats?.pending || 0
                                                                    },
                                                                    {
                                                                        name: 'In Progress',
                                                                        value: analyticsTaskStats?.inProgress || 0
                                                                    },
                                                                    {
                                                                        name: 'On Hold',
                                                                        value: analyticsTaskStats?.onHold || 0
                                                                    }
                                            ...
                                            <Grid item xs={12}>
                                                <Box className="chart-container-apple" sx={{height: '400px'}}>
                                                    ...
                                                    <ResponsiveContainer width="100%" height="85%">
                                                        ...
                                                        >
                                                            <defs>
                                                                <linearGradient id="colorTasks" x1="0" y1="0" x2="0"
                                                                                y2="1">
                                                    ...
                                                    <ResponsiveContainer width="100%" height="85%">
                                                        ...
                                                        >
                                                            ...
                                                            <Bar dataKey="completed" stackId="a" fill="#10b981"
                                                                 name="Completed" radius={[0, 8, 8, 0]}/>
                                                            <Bar dataKey="pending" stackId="a" fill="#f59e0b"
                                                                 name="Pending" radius={[0, 8, 8, 0]}/>
                                                        </BarChart>
                                                    </ResponsiveContainer>
                                                </Box>
                                            </Grid>
